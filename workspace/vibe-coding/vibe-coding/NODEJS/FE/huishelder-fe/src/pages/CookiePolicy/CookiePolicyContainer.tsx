  ...
  return (
    <>
      ...
      <section className={styles.section}>
        <h2>Introduction</h2>
        <p>
          This Cookie Policy explains how HuisHelder ("we", "us", and "our") uses cookies and
      ...
      <section className={styles.section}>
        ...
        <p>
          Cookies set by the website owner (in this case, HuisHelder) are called "first-party
      ...
      <section className={styles.section}>
        ...
        <div className={styles.cookieTypes}>
          <h3>The specific types of cookies we use are:</h3>

          <div className={styles.cookieType}>
            <h4>Essential cookies</h4>
            <p>
              These cookies are strictly necessary to provide you with services available through
              our website and to use some of its features, such as access to secure areas. These
              help make a website usable by enabling basic functions like page navigation and access
              to secure areas of the website.
            </p>
          </div>

          <div className={styles.cookieType}>
            <h4>Performance & Functionality cookies</h4>
            <p>
              These cookies are used to enhance the performance and functionality of our website,
              but are non-essential to its use. However, without these cookies, certain
          ...
          <div className={styles.cookieType}>
            ...
            <p>
              These cookies collect information that is used to help us understand how our website
              is being used or how effective our marketing campaigns are. They also help us to
              customize our website for you in order to enhance your experience.
            </p>
          </div>
          ...
          <div className={styles.cookieType}>
            ...
            <p>
              ...
              interests. They also perform functions like preventing the same ad from continuously
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          banner or in our Cookie Preference Center.
        </p>
        <p>
        ...
        <ul className={styles.bulletList}>
          <li>
            <a href="http://www.aboutads.info/choices/" className={styles.link}>
              Digital Advertising Alliance
            </a>
          </li>
          <li>
            <a href="https://www.youronlinechoices.com" className={styles.link}>
