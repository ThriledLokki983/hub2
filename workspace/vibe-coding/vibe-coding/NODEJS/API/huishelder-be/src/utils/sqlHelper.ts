...
export class SqlHelper {
  ...
  /**
   * Get SQL query for updating only user photo fields
   */
  public static getUpdateUserPhotoQuery(): string {
    return `
      UPDATE users
      SET
        photo_url = $2,
  ...
  /**
   * Get SQL query for removing a user's photo
   */
  public static getRemoveUserPhotoQuery(): string {
    return `
      UPDATE users
      SET
        photo_url = NULL,
