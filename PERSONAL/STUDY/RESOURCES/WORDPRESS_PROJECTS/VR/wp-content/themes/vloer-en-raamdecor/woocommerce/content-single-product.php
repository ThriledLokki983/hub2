    ...
    <section class="modulo__installation details">
        <article class="left">
            <div class="product-card-title-primary">
                ...
                <h2 class="product-text"><?php echo get_field('checklist_title','option') ?></h2>
            </div>
            <ul class="lists">
                <?php foreach (get_field('checklist_list', 'option') as $item) : ?>
                <li class="lists-item">
                    <svg class="icon">
...
<!--                        >-->
                <h2 class="product-text">Beschrijving <?php echo $category_name; ?></h2>
            </div>
