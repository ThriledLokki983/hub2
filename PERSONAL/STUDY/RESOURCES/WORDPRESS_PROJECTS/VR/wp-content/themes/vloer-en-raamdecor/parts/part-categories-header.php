...
<div class="categories__header--container">
        ...
        <div class="categories__header--container-left-text">
            <picture class="hero__big--img">
                ...
                <div class="hero__big--overlay">
                    ...
                    <h2><?= $fields['intro_image_overlay_title_2'] ?></h2>
                </div>
            </picture>
        </div>
    </div>
    <div class="categories__header--container-right">
        ...
        <?php if (!empty($fields['intro_text_button_label']) && !empty($fields['intro_text_button_link'])) : ?>
            <a href="<?= $fields['intro_text_button_link'] ?>" class="btn black"><?= $fields['intro_text_button_label'] ?></a>
        <?php endif; ?>
    </div>
</div>