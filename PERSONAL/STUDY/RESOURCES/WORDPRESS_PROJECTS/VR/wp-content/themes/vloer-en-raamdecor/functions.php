...
//    unset($fields['order']['order_comments']);
    ...
    $fields['billing']['billing_phone']['label'] = 'Telefoonnummer';
...
// Custom image size for product page
add_image_size( 'vr-single-product-image', 700, 700, array('center'), ); // Hard crop left top
