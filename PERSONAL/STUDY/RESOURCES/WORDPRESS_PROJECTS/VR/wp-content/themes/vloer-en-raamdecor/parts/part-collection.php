    ...
    <ul class="collection__items">
        <?php foreach (array_slice($products, 0, 3) as $item) : ?>
            ...
            <li class="collection__items--item">
                <a href="<?= get_permalink($item->ID) ?>" class="collection__items--item-link-right" aria-label="Product link">
                    <figure>
        ...
        <li class="collection__items--item">
            <a href="<?= get_sub_field('collection_b1_link'); ?>" class="collection__items--item-link-right" aria-label="Product link">
                <figure>
                    <?php
        ...
        <li class="collection__items--item special">
            <a href="<?= get_sub_field('collection_b2_button_link'); ?>" class="collection__items--item-link-left" aria-label="Product link">
                <figure>
