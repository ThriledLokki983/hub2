...
<section class="location container--full">
    ...
    <picture class="">
        <source srcset="<?= TPL_DIR_URI ?>/public/assets/img/prefooter.png" media="(min-width: 75em)"
                type="image/png"/>
        <source srcset="<?= TPL_DIR_URI ?>/public/assets/img/prefooter-mobile.png" media="(max-width: 600px)"
                type="image/png"/>
        <img src="<?= TPL_DIR_URI ?>/public/assets/img/prefooter.png" loading="lazy" decoding="async"
        ...
        <div class=" location-message">
            <article class="description">
                ...
                <a href="<?= $fields['location_button_link'] ?>"
                   class="btn primary small"><?= $fields['location_button_label'] ?></a>
            </article>
        </div>
    </picture>
</section>