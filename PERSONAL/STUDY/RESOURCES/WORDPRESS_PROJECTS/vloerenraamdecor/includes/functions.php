...
function calculatePriceBySquareMeters($productId, $squareMeters)
{
    ...
    // render message
    $message = "Je hebt aangegeven voor {$squareMeters} vierkante meter nodig te hebben. ";
    $message .= "Hiervoor heb je {$packsCount} pakken nodig. ";
...
function calculatePriceByNumberOfPacks($productId, $packsCount)
{
    ...
    // render message
    $message = "Je hebt aangegeven {$packsCount} pakken nodig te zijn. ";
    $message .= "Dit is voldoende voor {$squareMeters} m2. ";
    $message .= "We houden daarbij rekening met 10% snijverlies.";
