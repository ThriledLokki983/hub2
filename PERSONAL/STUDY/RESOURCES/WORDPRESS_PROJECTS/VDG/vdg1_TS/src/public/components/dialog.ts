 ...
 * @summary 02-01-2022
 * @author Gideon Nimoh
 * @description Custom versions of `alert`, `confirm` and `prompt`, using `<dialog>` Improve on it if you think it's useful.
 */
export default class Dialog {
  ...
  init() {
    ;(this.dialogSupported as HTMLDialogElement as any) === 'function'
    ...
    <form method="dialog" data-ref="form">
      ...
      <menu>
        ...
        <button${
          this.dialogSupported ? '' : ` type="button"`
        } data-ref="accept" value="default" class="btn__back" data-offset="-1"></button>
      </menu>
  ...
  open(settings = {}) {
    ...
    this.elements.target = (dialog as any).target || ''
