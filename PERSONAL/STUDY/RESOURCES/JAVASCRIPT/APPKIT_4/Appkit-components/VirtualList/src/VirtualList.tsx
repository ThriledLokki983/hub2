...
export function RawList<T>(props: any, ref: React.Ref<ListRef>) {
  const {
  ...
  // =============================== In Range ===============================
  const maxScrollHeight = scrollHeight - (height || 0);
  ...
  let componentStyle: React.CSSProperties | null = null;
  if (height) {
...
const VirtualList = React.forwardRef<ListRef, ListProps<any>>(RawList);

VirtualList.displayName = 'VirtualList';

export default VirtualList as <Item = any>(
  props: React.PropsWithChildren<ListProps<any>> & { ref?: React.Ref<ListRef> },
) => React.ReactElement;
