...
import { useControlled, useClickOutside, usePortal } from '../../../hooks';
...
import { uuid as _uuid, toArray } from '../../../util/helpers';
import useOptions from './useOptions';
import useFilterOptions from './useFilterOptions';
import { positionElement as align } from '../../../util/positionElement';
...
const Select: React.FC<SelectProps> = (props) => {
    ...
    const onInternalSelect = useCallback((v: any, item: any, e: any, k: any) => {
