...
//                 const newLi = (
//                     <li key={index} className="MainSearch-bar__history-item">
//                         <span
//                             onClick={() => {
...
//                             <span
//                                 className="MainSearch-bar__history-remove"
//                                 onClick={() => {
...
//             // For selectable input types ("text", "MainSearch"), only Select the hint if
...
//         ...childProps,
//         ref: inputRef,
//         placeholder: childProps.placeholder || 'MainSearch something',
//         className: `${childProps.className || ''} MainSearch-bar__input`,
//         autoComplete: "off",
//         onFocus,
//         onKeyDown,
//         onChange,
...
//                     tabIndex={-1}
//                 />
//                 <ul className="MainSearch-bar__history">{nodes.map((node) => node)}</ul>
//             </div>
//         ) : mainInput
//     );
// };
