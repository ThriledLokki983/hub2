...
import { getScrollWidth } from '../../../util/helpers';
    ...
    useEffect(() => {
        if (visible) {
            ...
            if (modalRef.current) {
                ...
                const focusIndex = initialFocusIndex >= 0 ? initialFocusIndex : focusable.length + initialFocusIndex;
