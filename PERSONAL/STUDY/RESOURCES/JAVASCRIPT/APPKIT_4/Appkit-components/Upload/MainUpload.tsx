...
const MainUpload: React.FC<UploadProps> = (parmprops) => {
  ...
  */
  ...
  /**
   * API: MainUpload file on trigger
   */
  const submit = (): void => {
  ...
  // Generate MainUpload list section
