...
//   console.log('close===', close, timeout)
...
//   const curStyle = (type === 'Alert' ? 'auto' : '100%');
...
//         item && (
//           <animated.div
//             className="ap-notification__message"
//             onMouseEnter={onMouseEnter}
//             onMouseLeave={onMouseLeave}
//             style={{
//               opacity: transprops.opacity,
//               height: transprops.height,
//               ...style,
//             }}
//           >
//             {console.log('transprops.transform===', transprops.transform)}
//             <animated.div
//               style={{
//                 transform: transprops.transform,
//                 pointerEvents: "auto",
//                 width: curStyle
//               }}
//               ref={container}
//               className="ap-notification__message-wrapper"
//             >
//               {renderMessage()}
//             </animated.div>
//           </animated.div>
