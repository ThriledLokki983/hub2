        ...
        <div className='accordion-item mb-5'>
          ...
          >
            ...
            <h3 className='fs-3 text-gray-800 fw-bolder mb-0 ms-4'>
              {REACT_APP_THEME_NAME} {REACT_APP_VERSION} - October 5, 2021
            </h3>
          </div>
          <div
            ...
            <div className='accordion-body ps-0 pt-0'>
              <div className='mb-5'>
                ...
                <ul className='my-0 py-0'>
                  <li className='py-2'>Fixed Sign Out button in user menu. <a href="https://preview.keenthemes.com/metronic8/react/demo1">Preview</a></li>
                </ul>
              </div>
            </div>
          </div>
